...
onAddTask is a function passed from the parent to add a new task. */
  ...
  return (
    <form action="bg-white p-6 rounded-xl shadow-sm border mb-8" onSubmit={handleSubmit}>
      ...
      <button  className = "w-full py-2 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition-colors" type="submit">Add Task</button>
      </div>
    </form>
  );
}
